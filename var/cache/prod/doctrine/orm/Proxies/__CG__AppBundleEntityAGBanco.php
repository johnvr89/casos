 ...
 */
class AGBanco extends \AppBundle\Entity\AGBanco implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\AGBanco' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\AGBanco' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\AGBanco' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\AGBanco' . "\0" . 'cuenta', '' . "\0" . 'AppBundle\\Entity\\AGBanco' . "\0" . 'usuarioCrea', '' . "\0" . 'AppBundle\\Entity\\AGBanco' . "\0" . 'usuarioModifica', '' . "\0" . 'AppBundle\\Entity\\AGBanco' . "\0" . 'fechaCrea', '' . "\0" . 'AppBundle\\Entity\\AGBanco' . "\0" . 'fechaModifica'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AGBanco $proxy) {
    ...
    public function addCuentum(\AppBundle\Entity\AGCuenta $cuentum)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addCuentum', [$cuentum]);

        return parent::addCuentum($cuentum);
    }
    ...
    public function removeCuentum(\AppBundle\Entity\AGCuenta $cuentum)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeCuentum', [$cuentum]);

        return parent::removeCuentum($cuentum);
    }
