 ...
 */
class AGCuenta extends \AppBundle\Entity\AGCuenta implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\AGCuenta' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\AGCuenta' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\AGCuenta' . "\0" . 'numero', '' . "\0" . 'AppBundle\\Entity\\AGCuenta' . "\0" . 'banco', '' . "\0" . 'AppBundle\\Entity\\AGCuenta' . "\0" . 'tipoCuenta', '' . "\0" . 'AppBundle\\Entity\\AGCuenta' . "\0" . 'pagoRealizado', '' . "\0" . 'AppBundle\\Entity\\AGCuenta' . "\0" . 'usuarioCrea', '' . "\0" . 'AppBundle\\Entity\\AGCuenta' . "\0" . 'usuarioModifica', '' . "\0" . 'AppBundle\\Entity\\AGCuenta' . "\0" . 'fechaCrea', '' . "\0" . 'AppBundle\\Entity\\AGCuenta' . "\0" . 'fechaModifica', '' . "\0" . 'AppBundle\\Entity\\AGCuenta' . "\0" . 'visible'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AGCuenta $proxy) {
