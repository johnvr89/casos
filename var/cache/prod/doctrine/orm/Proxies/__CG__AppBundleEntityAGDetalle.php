 ...
 */
class AGDetalle extends \AppBundle\Entity\AGDetalle implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\AGDetalle' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\AGDetalle' . "\0" . 'valor', '' . "\0" . 'AppBundle\\Entity\\AGDetalle' . "\0" . 'caso', '' . "\0" . 'AppBundle\\Entity\\AGDetalle' . "\0" . 'tipoCasoCaracteristica', '' . "\0" . 'AppBundle\\Entity\\AGDetalle' . "\0" . 'usuarioCrea', '' . "\0" . 'AppBundle\\Entity\\AGDetalle' . "\0" . 'usuarioModifica', '' . "\0" . 'AppBundle\\Entity\\AGDetalle' . "\0" . 'fechaCrea', '' . "\0" . 'AppBundle\\Entity\\AGDetalle' . "\0" . 'fechaModifica', '' . "\0" . 'AppBundle\\Entity\\AGDetalle' . "\0" . 'visible'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AGDetalle $proxy) {
    ...
    public function setTipoCasoCaracteristica(\AppBundle\Entity\AGTipoCasoCaracteristica $tipoCasoCaracteristica)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTipoCasoCaracteristica', [$tipoCasoCaracteristica]);

        return parent::setTipoCasoCaracteristica($tipoCasoCaracteristica);
    }
