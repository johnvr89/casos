 ...
 */
class AGDocumento extends \AppBundle\Entity\AGDocumento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\AGDocumento' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\AGDocumento' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\AGDocumento' . "\0" . 'url', '' . "\0" . 'AppBundle\\Entity\\AGDocumento' . "\0" . 'seguimiento', '' . "\0" . 'AppBundle\\Entity\\AGDocumento' . "\0" . 'pago', '' . "\0" . 'AppBundle\\Entity\\AGDocumento' . "\0" . 'usuarioCrea', '' . "\0" . 'AppBundle\\Entity\\AGDocumento' . "\0" . 'usuarioModifica', '' . "\0" . 'AppBundle\\Entity\\AGDocumento' . "\0" . 'fechaCrea', '' . "\0" . 'AppBundle\\Entity\\AGDocumento' . "\0" . 'fechaModifica'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AGDocumento $proxy) {
