 ...
 */
class AGEstado extends \AppBundle\Entity\AGEstado implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\AGEstado' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\AGEstado' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\AGEstado' . "\0" . 'caso', '' . "\0" . 'AppBundle\\Entity\\AGEstado' . "\0" . 'usuarioCrea', '' . "\0" . 'AppBundle\\Entity\\AGEstado' . "\0" . 'usuarioModifica', '' . "\0" . 'AppBundle\\Entity\\AGEstado' . "\0" . 'fechaCrea', '' . "\0" . 'AppBundle\\Entity\\AGEstado' . "\0" . 'fechaModifica'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AGEstado $proxy) {
