 ...
 */
class AGFormaPago extends \AppBundle\Entity\AGFormaPago implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\AGFormaPago' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\AGFormaPago' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\AGFormaPago' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\AGFormaPago' . "\0" . 'pagoRealizado', '' . "\0" . 'AppBundle\\Entity\\AGFormaPago' . "\0" . 'usuarioCrea', '' . "\0" . 'AppBundle\\Entity\\AGFormaPago' . "\0" . 'usuarioModifica', '' . "\0" . 'AppBundle\\Entity\\AGFormaPago' . "\0" . 'fechaCrea', '' . "\0" . 'AppBundle\\Entity\\AGFormaPago' . "\0" . 'fechaModifica'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AGFormaPago $proxy) {
