 ...
 */
class AGSeguimiento extends \AppBundle\Entity\AGSeguimiento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\AGSeguimiento' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\AGSeguimiento' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\AGSeguimiento' . "\0" . 'cambioEstado', '' . "\0" . 'AppBundle\\Entity\\AGSeguimiento' . "\0" . 'observacion', '' . "\0" . 'AppBundle\\Entity\\AGSeguimiento' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\AGSeguimiento' . "\0" . 'caso', '' . "\0" . 'AppBundle\\Entity\\AGSeguimiento' . "\0" . 'responsableSeguimiento', '' . "\0" . 'AppBundle\\Entity\\AGSeguimiento' . "\0" . 'usuarioCrea', '' . "\0" . 'AppBundle\\Entity\\AGSeguimiento' . "\0" . 'usuarioModifica', '' . "\0" . 'AppBundle\\Entity\\AGSeguimiento' . "\0" . 'fechaCrea', '' . "\0" . 'AppBundle\\Entity\\AGSeguimiento' . "\0" . 'fechaModifica', '' . "\0" . 'AppBundle\\Entity\\AGSeguimiento' . "\0" . 'visible'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AGSeguimiento $proxy) {
    ...
    public function setCambioEstado($cambioEstado)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCambioEstado', [$cambioEstado]);

        return parent::setCambioEstado($cambioEstado);
    }
    ...
    public function getCambioEstado()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCambioEstado', []);

        return parent::getCambioEstado();
    }
    ...
    public function setResponsableSeguimiento(\AppBundle\Entity\AGUsuario $responsableSeguimiento)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setResponsableSeguimiento', [$responsableSeguimiento]);

        return parent::setResponsableSeguimiento($responsableSeguimiento);
    }
    ...
    public function getResponsableSeguimiento()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getResponsableSeguimiento', []);

        return parent::getResponsableSeguimiento();
    }
