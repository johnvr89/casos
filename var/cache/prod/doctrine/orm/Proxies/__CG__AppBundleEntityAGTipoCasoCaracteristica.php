 ...
 */
class AGTipoCasoCaracteristica extends \AppBundle\Entity\AGTipoCasoCaracteristica implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\AGTipoCasoCaracteristica' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\AGTipoCasoCaracteristica' . "\0" . 'nombreCampo', '' . "\0" . 'AppBundle\\Entity\\AGTipoCasoCaracteristica' . "\0" . 'detalle', '' . "\0" . 'AppBundle\\Entity\\AGTipoCasoCaracteristica' . "\0" . 'tipoCaso', '' . "\0" . 'AppBundle\\Entity\\AGTipoCasoCaracteristica' . "\0" . 'tipoCampo', '' . "\0" . 'AppBundle\\Entity\\AGTipoCasoCaracteristica' . "\0" . 'usuarioCrea', '' . "\0" . 'AppBundle\\Entity\\AGTipoCasoCaracteristica' . "\0" . 'usuarioModifica', '' . "\0" . 'AppBundle\\Entity\\AGTipoCasoCaracteristica' . "\0" . 'fechaCrea', '' . "\0" . 'AppBundle\\Entity\\AGTipoCasoCaracteristica' . "\0" . 'fechaModifica', '' . "\0" . 'AppBundle\\Entity\\AGTipoCasoCaracteristica' . "\0" . 'visible'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AGTipoCasoCaracteristica $proxy) {
    ...
    public function setNombreCampo($nombreCampo)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNombreCampo', [$nombreCampo]);
    ...
    public function getNombreCampo()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNombreCampo', []);
    ...
    public function setTipoCampo(\AppBundle\Entity\AGTipoDatos $tipoCampo)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTipoCampo', [$tipoCampo]);

        return parent::setTipoCampo($tipoCampo);
    }
    ...
    public function getTipoCampo()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTipoCampo', []);

        return parent::getTipoCampo();
    }
