 ...
 */
class AGTipoCliente extends \AppBundle\Entity\AGTipoCliente implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\AGTipoCliente' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\AGTipoCliente' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\AGTipoCliente' . "\0" . 'empresa', '' . "\0" . 'AppBundle\\Entity\\AGTipoCliente' . "\0" . 'usuarioCrea', '' . "\0" . 'AppBundle\\Entity\\AGTipoCliente' . "\0" . 'usuarioModifica', '' . "\0" . 'AppBundle\\Entity\\AGTipoCliente' . "\0" . 'fechaCrea', '' . "\0" . 'AppBundle\\Entity\\AGTipoCliente' . "\0" . 'fechaModifica'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AGTipoCliente $proxy) {
