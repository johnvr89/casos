 ...
 */
class AGTipoCobro extends \AppBundle\Entity\AGTipoCobro implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\AGTipoCobro' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\AGTipoCobro' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\AGTipoCobro' . "\0" . 'pagosRealizados', '' . "\0" . 'AppBundle\\Entity\\AGTipoCobro' . "\0" . 'usuarioCrea', '' . "\0" . 'AppBundle\\Entity\\AGTipoCobro' . "\0" . 'usuarioModifica', '' . "\0" . 'AppBundle\\Entity\\AGTipoCobro' . "\0" . 'fechaCrea', '' . "\0" . 'AppBundle\\Entity\\AGTipoCobro' . "\0" . 'fechaModifica'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AGTipoCobro $proxy) {
    ...
    public function addPagosRealizado(\AppBundle\Entity\AGPagoRealizado $pagosRealizado)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addPagosRealizado', [$pagosRealizado]);

        return parent::addPagosRealizado($pagosRealizado);
    }
    ...
    public function removePagosRealizado(\AppBundle\Entity\AGPagoRealizado $pagosRealizado)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removePagosRealizado', [$pagosRealizado]);

        return parent::removePagosRealizado($pagosRealizado);
    }
    ...
    public function getPagosRealizados()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPagosRealizados', []);

        return parent::getPagosRealizados();
    }
