    ...
    form.submit(function(event) {
        ...
        {   
            $.ajax({
                ...
                url: serviceaddress + '/api/token-authentication',
                ...
                error: function(response)
                {
                    ...
                    $("#login-alert").html("Ha ocurrido un error");
                },
                success: function(response)
                {
                    ...
                    {
                        sessionStorage.auth_token = response.token;
